            ...
            {openProfileImage
                ? <div>
                    <div className="flex justify-center">
                        <img className="h-100 w-80" src={userData.image} alt="" />
                ...
                : <div className="w-[92%] md:w-[80%] m-auto">
                    {edit
                        ? <div className="w-40 h-40">
                            <label htmlFor="image">
                                <img className="cursor-pointer" src={image ? URL.createObjectURL(image) : assets.image_upload} alt="" />
                                {/* <i class="fa-solid fa-upload fa-7x"></i> */}
                            </label>
                            <input type="file" id="image" onChange={(e) => setImage(e.target.files[0])} hidden />
                        </div>
                        : <img onClick={() => setOpenProfileImage(true)} className="w-40 h-40 object-cover rounded-full cursor-pointer" src={userData.image} alt="" />
                    }
