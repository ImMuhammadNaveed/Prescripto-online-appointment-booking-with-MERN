        ...
        <>
            <div className='w-[92%] md:w-[80%] m-auto'>
                ...
                <div className='flex md:flex-row flex-col items-center'>
                    <img src={assets.about_image} alt="" className='w-full md:w-100 h-90 object-cover' />
                ...
                <div className='flex md:flex-row flex-col'>
                    <div className='group w-full md:w-[33.33%] md:p-20 p-6 border border-gray-200 hover:bg-primary hover:text-white transition-colors duration-300 cursor-pointer'>
                    ...
                    <div className='group w-full md:w-[33.33%] md:p-20 p-6 border border-gray-200 hover:bg-primary text-white transition-colors duration-300 cursor-pointer'>
